...
*/
        ...
        placesList.add(new Places(getString(R.string.havmor_name), getString(R.string.sample_description), R.drawable.restaurant, Integer.toString((int) distance[0][0] / 1000)));
        placesList.add(new Places(getString(R.string.havmor_name), getString(R.string.sample_description), R.drawable.restaurant, Integer.toString((int) distance[0][0] / 1000)));
        placesList.add(new Places(getString(R.string.havmor_name), getString(R.string.sample_description), R.drawable.restaurant, Integer.toString((int) distance[0][0] / 1000)));
        placesList.add(new Places(getString(R.string.havmor_name), getString(R.string.sample_description), R.drawable.restaurant, Integer.toString((int) distance[0][0] / 1000)));
        placesList.add(new Places(getString(R.string.havmor_name), getString(R.string.sample_description), R.drawable.restaurant, Integer.toString((int) distance[0][0] / 1000)));
